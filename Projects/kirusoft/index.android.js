...
export default class kirusoft extends Component {
  render() {
    return (
      <View style={styles.container}>
        <Image source={require('./src/img/buckler.png')} style={styles.backimg} />
...
AppRegistry.registerComponent('kirusoft', () => kirusoft);
